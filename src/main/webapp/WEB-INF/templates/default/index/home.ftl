...
<head>
    ...
    <title>${member.name}主页 - ${SITE_NAME} - Powered By 囊萤科技</title>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div>
                                ...
                                <#if type=="article">
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/article"
                                ...
                                <#elseif type=="groupTopic">
                                    <#list model.data as groupTopic>
                                        <div class="ibox-content col-sm-12 bottom-line">
                                            <div class="col-sm-10">
                                                ...
                                                <h3>
                                                    <a href="${base}/group/topic/${groupTopic.id}" class="btn-link">
                                                    ${groupTopic.title}
                                                    </a>
                                                </h3>
                                            ...
                                            <#if groupTopic.thumbnail??>
                                                <div class="col-sm-2">
                                                    <div class="text-center list-thumbnail">
                                                        <a href="${base}/article/detail/${groupTopic.id}" class="btn-link">
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/groupTopic"
                                            currentPage="${model.page.pageNo}"
                                            pageCount="${model.page.totalPage}">
                                        </ul>
                                    </div>
                                <#elseif type=="weibo">
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/weibo"
                                            currentPage="${model.page.pageNo}"
                                            pageCount="${model.page.totalPage}">
                                        </ul>
                                    </div>
                                <#elseif type=="group">
                                    <#list model.data as groupFans>
                                        <div class="feed-element">
                                            <a href="${base}/group/detail/${groupFans.group.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${groupFans.group.logo}">
                                            </a>
                                            <div class="media-body ">
                                                <h4><strong><a href="${base}/group/detail/${groupFans.group.id}">${groupFans.group.name}</a></strong></h4>
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/group"
                                            currentPage="${model.page.pageNo}"
                                            pageCount="${model.page.totalPage}">
                                        </ul>
                                    </div>
                                <#elseif type=="follows">
                                    <#list model.data as memberFans>
                                        <div class="feed-element">
                                            <a href="${base}/u/${memberFans.followWhoMember.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${memberFans.followWhoMember.avatar}">
                                            </a>
                                            <div class="media-body ">
                                                <h4><strong><a href="${base}/u/${memberFans.followWhoMember.id}">${memberFans.followWhoMember.name}</a></strong></h4>
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/follows"
                                            currentPage="${model.page.pageNo}"
                                            pageCount="${model.page.totalPage}">
                                        </ul>
                                    </div>
                                <#elseif type=="fans">
                                    <#list model.data as memberFans>
                                        <div class="feed-element">
                                            <a href="${base}/u/${memberFans.whoFollowMember.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${memberFans.whoFollowMember.avatar}">
                                            </a>
                                            <div class="media-body ">
                                                <h4><strong><a href="${base}/u/${memberFans.whoFollowMember.id}">${memberFans.whoFollowMember.name}</a></strong></h4>
                                    ...
                                    <div class="box-footer clearfix">
                                        <ul class="pagination pagination-sm no-margin pull-right"
                                            url="${base}/u/${member.id}/home/fans"
                                            currentPage="${model.page.pageNo}"
                                            pageCount="${model.page.totalPage}">
                                        </ul>
                                    </div>
